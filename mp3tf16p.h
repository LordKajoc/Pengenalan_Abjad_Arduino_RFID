...
public:
    ...
    // void playTrackFolder(int folderNumber, int volume, boolean waitPlayTerminated2 = true);
...
// void MP3Player::playTrackFolder(int folderNumber, int trackNumber, int volume, boolean waitPlayTerminated2 = true)
// {
//   player.volume(volume);
//   player.playFolder(folderNumber, trackNumber);
//   if(waitPlayTerminated2)
//   {
//     waitPlayIsTerminated();
//   }
